...
set(CMAKE_CXX_FLAGS                                "${CMAKE_CXX_FLAGS} -std=c++17 -W -Wall -Wextra -fmax-errors=5 -fdiagnostics-parseable-fixits")
...
set(EXTRA_CXX_FLAGS "${EXTRA_CXX_FLAGS} -fdiagnostics-show-option -Wuseless-cast")
...
if(WERROR_LEVEL_1)
    set(PARANO_CMAKE_CXX_FLAGS "${PARANO_CMAKE_CXX_FLAGS} -Werror=format-security -Wformat -Werror=aggressive-loop-optimizations")
    set(PARANO_CMAKE_CXX_FLAGS "${PARANO_CMAKE_CXX_FLAGS} -Werror=missing-field-initializers")
    set(PARANO_CMAKE_CXX_FLAGS "${PARANO_CMAKE_CXX_FLAGS} -Werror=conversion -Werror=logical-op")
    set(PARANO_CMAKE_CXX_FLAGS "${PARANO_CMAKE_CXX_FLAGS} -Werror=zero-as-null-pointer-constant")
