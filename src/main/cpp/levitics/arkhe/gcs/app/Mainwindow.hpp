...
class MainWindow : public QMainWindow
{
    ...
    {
        GCS_MAINWINDOW_STYLE_DARK ,        /*!< DARK */
        GCS_MAINWINDOW_STYLE_LIGHT ,         /*!< LIGHT */
        GCS_MAINWINDOW_STYLE_NATIVE ,        /*!< NATIVE */
        GCS_MAINWINDOW_STYLE_INDOOR ,        /*!< INDOOR */
        GCS_MAINWINDOW_STYLE_OUTDOOR ,        /*!< OUTDOOR */
        GCS_MAINWINDOW_STYLE_OXYGEN ,        /*!< OXYGEN */
        GCS_MAINWINDOW_STYLE_WIN ,        /*!< WIN */
        GCS_MAINWINDOW_STYLE_KDE ,        /*!< KDE */
