#ifndef ARKHE_CORE_STATUSINDICATOR_HPP
#define ARKHE_CORE_STATUSINDICATOR_HPP
...
/*!
    ...
    \brief The StatusIndicator class lets an application display a progress indicator to show that a lengthy task is under way.
...
public:
    StatusIndicator(QWidget* parent = Q_NULLPTR );
