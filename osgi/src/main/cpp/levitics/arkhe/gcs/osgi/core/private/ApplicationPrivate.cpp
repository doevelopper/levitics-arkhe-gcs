...
void ApplicationPrivate::setApplication(QCoreApplication *q)
{
    app = q;
}


void ApplicationPrivate::initialize(void)
{
    ...
    QCommandLineOption loglevelOption("loglevel", "log level available: trace|debug|info|warn|error|fatal", "level", verbosity);
