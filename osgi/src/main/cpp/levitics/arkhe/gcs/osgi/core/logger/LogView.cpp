...
void
LogView::autoScrollChecked( int state )
{
...
void
LogView::disableAutoScroll( void )
{
...
void
LogView::displayTrace( bool display )
{
    if( !display )
    {
        d->exclude << "TRACE";
...
void
LogView::displayDebug( bool display )
{
    if( !display )
        d->exclude << "DEBUG";
    else
...
void
LogView::displayInfo( bool display )
{
    if( !display )
        d->exclude << "INFO";
    else
...
void
LogView::displayWarn( bool display )
{
    if( !display )
        d->exclude << "WARN";
    else
...
void
LogView::displayError( bool display )
{
    if( !display )
        d->exclude << "ERROR";
    else
...
void
LogView::displayFatal( bool display )
{
    if( !display )
        d->exclude << "FATAL";
    else
