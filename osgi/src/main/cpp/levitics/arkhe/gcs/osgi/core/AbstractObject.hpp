...
protected:
    ...
    AbstractObject(AbstractObjectPrivate& dd, QObject *parent);
    AbstractObject(AbstractObjectPrivate& dd, const AbstractObject& other);
    AbstractObjectPrivate *d_func()
    {
        return (d_ptr);
    }
    const AbstractObjectPrivate *d_func() const
    {
        return (d_ptr);
    }
