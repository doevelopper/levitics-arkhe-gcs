...
AbstractObject::AbstractObject( AbstractObjectPrivate & dd,
    QObject * parent )
    :   QObject( parent ),
    d_ptr( &dd )
{
...
void
AbstractObject::copy( const AbstractObject & other )
{
    if( this == &other )
    {
        return;
...
bool
AbstractObject::operator ==( const AbstractObject & other ) const
{
    return (this->isEqual( other ) );
}

bool
AbstractObject::isEqual( const AbstractObject & other ) const
{
    if( this == &other )
    {
        return true;
...
QString
AbstractObject::description( ) const
{
...
QString
AbstractObject::identifier( ) const
{
    // GCS_DEFAULT_IMPLEMENTATION;
...
QString
AbstractObject::name( ) const
{
    return (this->objectName( ) );
}

int
AbstractObject::count( ) const
{
    return (d_ptr->count);
}

int
AbstractObject::retain( ) const
{
    return (d_ptr->count.fetchAndAddOrdered( 1 ) + 1);
}

int
AbstractObject::release( void ) const
{
...
void
AbstractObject::enableDeferredDeletion( bool value )
{
    d_ptr->isDeferredDeletionEnabled = value;
}

bool
AbstractObject::isDeferredDeletionEnabled( void ) const
{
    return (d_ptr->isDeferredDeletionEnabled);
}

void
AbstractObject::addProperty( const QString & key,
...
void
AbstractObject::setProperty( const QString & key,
    const QString & value )
{
...
QStringList
AbstractObject::propertyList( void ) const
{
    return d_ptr->properties.keys( );
}

QStringList
AbstractObject::propertyValues( const QString & key ) const
{
    if( d_ptr->values.contains( key ) )
    {
...
bool
AbstractObject::hasProperty( const QString & key ) const
{
    return (d_ptr->values.contains( key ) );
}

QString
AbstractObject::property( const QString & key ) const
{
    if( !d_ptr->values.contains( key ) )
    {
        qDebug( ) << this->metaObject( )->className( ) << "has no such property:" << key;
...
void
AbstractObject::addMetaData( const QString & key,
    const QStringList & values )
{
...
void
AbstractObject::setMetaData( const QString & key,
    const QStringList & values )
{
...
QStringList
AbstractObject::metaDataList( void ) const
{
    return (d_ptr->metadatas.keys( ) );
}

QStringList
AbstractObject::metaDataValues( const QString & key ) const
{
...
bool
AbstractObject::hasMetaData( const QString & key ) const
{
    return d_ptr->metadatas.contains( key );
}

void
AbstractObject::onPropertySet( const QString & key,
    const QString & value )
{
    GCS_UNUSED( key );
    GCS_UNUSED( value );
...
void
AbstractObject::onMetaDataSet( const QString & key,
    const QString & value )
{
    GCS_UNUSED( key );
    GCS_UNUSED( value );
...
QString
AbstractObject::metadata( const QString & key ) const
{
    if( !d_ptr->metadatas.contains( key ) )
    {
        qDebug( ) << this->metaObject( )->className( ) << "has no such property:" << key;
...
QStringList
AbstractObject::metadatas( const QString & key ) const
{
    if( !d_ptr->metadatas.contains( key ) )
    {
        qDebug( ) << this->metaObject( )->className( ) << "has no such property:" << key;
...
void
AbstractObject::copyMetaDataFrom( const AbstractObject * obj )
{
    if( !obj )
    {
        return;
