...
#ifndef LEVITICS_OSGI_CORE_ERRORHANDLING_EXCEPTION_HPP
#define LEVITICS_OSGI_CORE_ERRORHANDLING_EXCEPTION_HPP

#include <QObject>
#include <QException>

#include <levitics/osgi/core/error-handling/BackTrace.hpp>
